...
1. China joins the World Trade Organization, giving rise to higher demand in exports and higher consumption in coal energy to keep up with global productions, causing CO2 to rise.

2. Around 2014, China expands into more renewable energy and nuclear power; reducing demand for coal factories and causing CO2 to fall.

3. Around 2017, higher demand for exports caused coal consumption to increase and surpass renewables, causing CO2 to rise.
...
2. African, Middle Eastern, Central American and CIS (Commonwealth of Independent States) countries generates the least energy across all spectrums of energy sources, with the exception of countries such as Brazil relying on hydro electric and Russia relying on natural gas.
3. North america, mainly the US, generates the most energy across oil, natural gas and nuclear energy. The only country that matches the US in terms of volume is China, which generates the most energy across coal, hydro electric and renewables.
...
Renewable energy = Solar + Wind + Others (Biomass, Biofuels). 

Both the largest proportion and fastest growing source of renewable energy is Solar and Wind energy. Focusing on these two, we measure how countries performed in 2018 using a cleveland dot plot on Countries versus Energy Generation (Terawatt Hours), faceted on their Continents.
